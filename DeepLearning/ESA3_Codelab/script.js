...
/* 
Convert the input data to tensors that we can use for machine learnin. We will also
do the important best practices of _shuffling_ the data and _normalizing_ the data
*/
